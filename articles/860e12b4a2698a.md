...
type TaskInteractor struct {
    queries db.Queries  // sqlc の生成した interface をそのまま使う
}
...
[sqlc](https://sqlc.dev/) はSQLファイルからGoのコードを生成するツールです。生成されるコードは interface を含むため、テスト時にモックへ差し替えられます。
