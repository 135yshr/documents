...
To github.com:135yshr/documents.git
   982c0e3..1270c09  add-security-vulnerability-articles -> add-security-vulnerability-articles</bash-stdout><bash-stderr></bash-stderr>

### Prompt 28

です。ます口調になってい文章を修正してください。
修正の前に対象になるファイルを確認してください。

@articles/ 配下を対象にしてください
