...
Mitchell Hashimoto の講演 [Advanced Testing with Go](https://www.youtube.com/watch?v=8hQG7QlcLBk) でも紹介されていますが、Go の標準ライブラリはモックライブラリを使いません。テストファイル内にスタブ構造体を定義しています。本記事でも同じスタイルを採用しています。理由は次のとおりです。
