...
https://github.com/135yshr/documents/issues/36 を確認してください
...
meow の実装は、/Users/135yshr/go/src/github.com/135yshr/meow にあります
...
猫語だと語弊があるので猫に関連する言葉でプログラミングする言語にした方が適切です
...
articles/21b1fa2c9365cc.md に対象ファイルのパスが渡される（例: `articles/978121945958ed.md`）。パスが渡されない場合は「対象ファイルを指定してください（例: /review-doc articles/xxx.md）」とだけ返して終了すること。
